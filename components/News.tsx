...
export default function NewsSection() {
    ...
    return (
        ...
        <section id="news-section" className="flex flex-col items-center py-16 " >
            <div className="w-full max-w-7xl px-5">
                {/* หัวข้อ (ยังคงใช้การตั้งค่าเดิมที่ปรับแล้ว) */}
                <div className="mb-10 bg-gradient-to-r from-pink-200 to-green-200 text-black px-8 py-6 rounded-3xl shadow-lg shadow-teal-400/40 text-center relative overflow-hidden">
