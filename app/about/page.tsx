      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-50 rounded-2xl shadow-md p-6 flex flex-col items-center">
            <img
              src="https://via.placeholder.com/150" // เปลี่ยนเป็น path รูปจริงของคุณ
              alt="Developer 1"
              className="w-32 h-32 rounded-full object-cover mb-4"
            />
            <h2 className="text-xl font-semibold text-gray-800">วรวุฒิ ยาชัยยะ</h2>
            <p className="text-gray-600 mt-2 text-center">
              นักพัฒนา Full Stack ผู้เชี่ยวชาญด้าน React, Next.js และการออกแบบระบบฐานข้อมูล
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-2xl shadow-md p-6 flex flex-col items-center">
            ...
            <p className="text-gray-600 mt-2 text-center">
              ผู้เชี่ยวชาญด้าน UI/UX และการจัดการระบบ Backend ด้วย Prisma และ PostgreSQL
            </p>
          </div>
        </div>
      </div>
