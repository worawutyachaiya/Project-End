// app/cssvideo/page.tsx - Updated version with lesson filtering
"use client";
          ...
          <div className="w-full md:w-80 bg-white rounded-xl shadow-lg flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto">
              {filteredVideos.length === 0 ? (
                <div className="p-4 text-center text-gray-500">
                  <p>ไม่มีเนื้อหาวิดีโอ CSS ที่ต้องเรียน</p>
            ...
            <div className="p-4 border-t bg-gray-50">
              ...
              <button 
                ...
                className="w-full bg-gradient-to-r from-purple-500 to-purple-600 text-white py-3 rounded-lg hover:from-purple-600 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg font-medium"
              >
                ทำข้อสอบหลังเรียน
              </button>
            </div>
